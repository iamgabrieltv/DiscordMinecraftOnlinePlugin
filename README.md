...
If you have the idle timeout set in `server.properties` and have `idle-timeout.kick-if-idle` on false, the plugin will add the configured AFK prefix and suffix to the Discord Message.
